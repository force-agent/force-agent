...
import { env, warnUnrecognized } from "@opencode-ai/util/env"
...
const Handlers = Runtime.handlers(Commands, {
  ...
  browser: {
    ...
    navigate: () => import("./commands/handlers/browser/navigate"),
    snapshot: () => import("./commands/handlers/browser/snapshot"),
    act: () => import("./commands/handlers/browser/act"),
    read: () => import("./commands/handlers/browser/read"),
    screenshot: () => import("./commands/handlers/browser/screenshot"),
    tabs: () => import("./commands/handlers/browser/tabs"),
    control: () => import("./commands/handlers/browser/control"),
    network: () => import("./commands/handlers/browser/network"),
    fetch: () => import("./commands/handlers/browser/fetch"),
    eval: () => import("./commands/handlers/browser/eval"),
...
Effect.gen(function* () {
  ...
  // force-agent overlay: a branded LABHARNESS_*/LABFY_*/POWER_* variable this build never reads used to be
  // dropped in complete silence — the operator saw the shell accept it and had
  // no way to learn the process ignored it. Named out loud, on stderr, before
  // anything else runs.
  yield* Effect.sync(() => warnUnrecognized())
