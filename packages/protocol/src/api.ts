...
import { SelfUpdateGroup } from "./groups/self-update.js"
...
import { RoutineGroup } from "./groups/routine.js"
...
type LocationGroups<LocationId extends HttpApiMiddleware.AnyId> =
  ...
  | HttpApiGroup.AddMiddleware<typeof RoutineGroup, LocationId>
  ...
  | HttpApiGroup.AddMiddleware<typeof BrowserGroup, LocationId>
...
> =>
  HttpApi.make("server")
    ...
    .add(RoutineGroup.middleware(locationMiddleware))
    ...
    .add(BrowserGroup.middleware(locationMiddleware))
    .annotateMerge(
      OpenApi.annotations({
