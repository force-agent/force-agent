...
export class RoutineNotFoundError extends Schema.TaggedError<RoutineNotFoundError>()(
...
export class BrowserUnavailableError extends Schema.TaggedError<BrowserUnavailableError>()(
...
export class BrowserActionError extends Schema.TaggedError<BrowserActionError>()(
  "BrowserActionError",
  { message: Schema.String },
  { httpApiStatus: 400 },
) {}
