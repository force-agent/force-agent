  ...
  return (
    <header class="flex min-h-14 shrink-0 items-center justify-between gap-4 border-b border-border-weak-base px-4 py-2">
      ...
      <div class="flex shrink-0 items-center gap-2">
        {/* The product header lost its review toggle (Diffs is retired); the story keeps its own. */}
        <Show when={props.reviewVisible}>
          <Button size="small" variant="neutral" aria-pressed={props.reviewOpened} onClick={props.onReviewToggle}>
            Review
          </Button>
        </Show>
