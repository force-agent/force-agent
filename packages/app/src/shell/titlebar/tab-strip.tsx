...
export function TitlebarTabStrip(props: {
  ...
  /** Publishes the visibility-filtered order so keyboard navigation can honour it. */
  onVisibleTabsChange?: (tabs: readonly Tab[] | undefined) => void
}) {
  ...
  onCleanup(() => props.onVisibleTabsChange?.(undefined))
