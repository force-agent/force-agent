export const dict = {
  ...
  "session.sidebar.routines": "Rotinas",
  "session.sidebar.routines.empty": "As rotinas agendadas deste workspace aparecem aqui",
  "session.sidebar.routines.new": "Nova rotina",
  "session.sidebar.routines.next": "próx. {{time}}",
  "session.sidebar.routines.paused": "pausada",
  "session.sidebar.routines.run": "Executar agora",
  "session.sidebar.routines.toggle": "Ativada",
  "routine.dialog.create.title": "Nova rotina",
  "routine.dialog.edit.title": "Editar rotina",
  "routine.field.name": "Nome",
  "routine.field.name.placeholder": "Toda segunda: resumir leads novos",
  "routine.field.agent": "Agente",
  "routine.field.schedule": "Agendamento",
  "routine.field.time": "Horário",
  "routine.field.weekday": "Dia da semana",
  "routine.field.timezone": "Fuso horário",
  "routine.field.cron": "Expressão cron",
  "routine.field.cron.hint": "minuto hora dia mês dia-da-semana",
  "routine.field.cron.invalid": "Informe uma expressão cron válida de cinco campos",
  "routine.field.timezone.invalid": "Fuso horário desconhecido",
  "routine.field.minute.invalid": "Informe um minuto de 0 a 59",
  "routine.field.task": "Tarefa",
  "routine.field.task.prompt": "Prompt",
  "routine.field.task.command": "Comando do projeto",
  "routine.field.prompt.placeholder": "O que o agente deve fazer?",
  "routine.field.command.none": "Sem comandos no projeto",
  "routine.field.model": "Modelo",
  "routine.field.model.default": "Padrão do agente",
  "routine.field.enabled": "Ativada",
  "routine.preset.hourly": "A cada hora",
  "routine.preset.daily": "Todo dia",
  "routine.preset.weekly": "Toda semana",
  "routine.preset.custom": "Cron personalizado",
  "routine.history.title": "Últimas execuções",
  "routine.history.empty": "Nenhuma execução ainda",
  "routine.history.open": "Abrir sessão",
  "routine.status.running": "Executando",
  "routine.status.success": "Concluída",
  "routine.status.error": "Falhou",
  "routine.status.missed": "Perdida",
  "routine.status.cancelled": "Cancelada",
  "routine.error.save": "Não foi possível salvar a rotina",
  "routine.error.run": "Não foi possível iniciar a rotina",
  ...
  "session.review.filesChanged.one": "{{count}} arquivo alterado",
  "session.review.filesChanged.other": "{{count}} arquivos alterados",
  ...
  "settings.updates.action.restarting": "Reiniciando...",
  "settings.updates.toast.installing.title": "Atualizando para {{version}}...",
  "settings.updates.toast.installing.description": "Turnos em andamento continuam depois do reinício.",
  "settings.updates.toast.restarting.title": "Reiniciando na {{version}}...",
  "settings.updates.toast.restarting.description": "A página recarrega sozinha quando o servidor voltar.",
  "settings.updates.toast.timeout.title": "A atualização para {{version}} não terminou",
  "settings.updates.toast.timeout.description": "O servidor não voltou a tempo. Reinicie o force web manualmente.",
  "settings.updates.toast.manual.title": "{{version}} disponível",
  "settings.updates.toast.manual.description": "Esta instalação não consegue se atualizar sozinha. Rode: {{command}}",
  "settings.updates.toast.manual.noCommand": "Esta instalação não consegue se atualizar sozinha. Reinstale o force-agent para obtê-la.",
  "navSidebar.update.check": "Verificar atualizações",
  "navSidebar.update.install": "Atualizar para {{version}}",
  ...
  "session.sidebar.skills": "Skills",
  "session.sidebar.mcps": "Servidores MCP",
  "session.sidebar.skills.empty": "As skills deste workspace aparecem aqui",
  "session.sidebar.mcps.empty": "Nenhum servidor MCP",
  "session.sidebar.usage.active": "Em uso",
  "session.sidebar.usage.used": "Usada nesta sessão",
  "session.sidebar.agent.label": "Agente",
  "session.sidebar.agent.switch": "Trocar agente",
  "session.sidebar.browser": "Navegador",
  "session.sidebar.browser.empty": "Nenhuma página ainda — abra a aba Navegador",
  "session.sidebar.browser.open": "Abrir a aba Navegador",
  "session.sidebar.skills.search": "Filtrar skills",
  "session.sidebar.skills.noMatch": "Nenhuma skill corresponde",
  "session.sidebar.agents": "Subagentes",
  "session.sidebar.agents.empty": "Os subagentes que esta sessão criar aparecem aqui",
  "session.sidebar.tools": "Ferramentas",
  "session.sidebar.tools.empty": "Servidores MCP, chaves de API e CLIs detectados aparecem aqui",
  "session.sidebar.tools.error": "Não foi possível carregar as ferramentas — a detecção falhou",
  "session.sidebar.tools.channel.mcp": "Servidor MCP",
  "session.sidebar.tools.channel.api": "Chave de API",
  "session.sidebar.tools.channel.cli": "CLI",
  "session.sidebar.tools.chip.mcp": "MCP",
  "session.sidebar.tools.chip.api": "Chave de API",
  "session.sidebar.tools.chip.cli": "CLI",
  "session.sidebar.tools.notFound": "não encontrado",
  "session.sidebar.tools.notConnected": "não conectado",
  "session.sidebar.tools.connect": "Conectar",
  "session.sidebar.tools.disconnect": "Desconectar",
  "session.sidebar.tools.tools": "{{count}} tools",
  "session.sidebar.tools.pinned": "Fixada para este agente",
  "session.sidebar.tools.denied": "Não permitida para este agente",
  "session.sidebar.tools.refresh": "Atualizar detecção",
  "session.sidebar.tools.envKeys": "{{count}} chaves de ambiente",
  "session.tab.browser": "Navegador",
  "session.tab.browser.empty.title": "Sem navegador ainda",
  "session.tab.browser.empty.description": "O navegador deste agente vai viver aqui.",
  "session.browser.open": "Abrir navegador",
  "session.browser.opening": "Abrindo navegador…",
  "session.browser.tab.new": "Nova aba",
  "session.browser.tab.close": "Fechar aba",
  "session.browser.back": "Voltar",
  "session.browser.reload": "Recarregar",
  "session.browser.url.placeholder": "Digite uma URL",
  "session.browser.control.idle": "Livre",
  "session.browser.control.agent": "Agente",
  "session.browser.control.human": "Você",
  "session.browser.control.handoff-login": "Aguardando você",
  "session.browser.take": "Assumir",
  "session.browser.release": "Devolver",
  "session.browser.handoff.banner": "O agente precisa de você: {{reason}}",
  "session.browser.handoff.done": "Concluí",
  "session.browser.stream.connecting": "Conectando à página…",
  "session.browser.stream.closed": "Transmissão desconectada, reconectando…",
  "session.browser.error": "Erro do navegador: {{message}}",
  "command.project.copyID": "Copiar ID do projeto",
  "command.session.copyID": "Copiar ID da sessão",
  "dialog.directory.home": "Início",
  "navSidebar.title": "Espaços de trabalho",
  "navSidebar.newSession": "Nova sessão",
  "navSidebar.search.placeholder": "Filtrar projetos e sessões",
  "navSidebar.settings": "Configurações",
  "navSidebar.empty.projects": "Adicionar um projeto",
  "navSidebar.empty.sessions": "Nenhuma sessão ainda",
  "navSidebar.server.offline": "offline",
  "navSidebar.project.reveal": "Mostrar no gerenciador de arquivos",
  "navSidebar.session.unread": "Atividade não lida",
  "command.extensions.toggle": "Alternar painel de skills e MCP",
  "dialog.server.menu.hide": "Ocultar da lista de projetos",
  "dialog.server.menu.show": "Mostrar na lista de projetos",
  "server.row.incompatible": "Este servidor roda o OpenCode {{version}}, que não é compatível com este app. Atualize-o para o OpenCode V2 para continuar.",
  ...
  "error.page.title.status": "A requisição ao servidor falhou",
  "error.page.description.status": "O servidor respondeu com HTTP {{status}}.",
  "error.page.action.reload": "Recarregar",
  "session.tab.chat": "Chat",
  "session.tab.files": "Arquivos",
  "session.workspace.tabs": "Visões da sessão",
  "session.error.incompatible": "A versão deste servidor não é suportada",
  "session.error.incompatible.description": "{{server}} roda o OpenCode {{version}}, que não é compatível com este app. Atualize o servidor para o OpenCode V2 para continuar.",
  ...
  "session.background.running": "Executando trabalho em segundo plano",
  "session.background.runningCount.one": "{{count}} item em segundo plano",
  "session.background.runningCount.other": "{{count}} itens em segundo plano",
  ...
  "session.queue.steer": "Direcionar",
  ...
  "session.queue.attachments": "+ anexos",
  "session.timeline.notice.finished": "{{actor}} terminou",
  "session.timeline.notice.failed": "{{actor}} falhou",
  "session.timeline.notice.cancelled": "{{actor}} cancelado",
  "session.files.csv.empty": "Arquivo CSV vazio",
  "session.files.csv.download": "Baixar CSV",
  "session.files.csv.tooLarge": "Este CSV é grande demais para a prévia. Baixe o arquivo.",
  "session.files.csv.rows": "{{count}} linhas",
  "session.files.csv.columns": "{{count}} colunas",
  "session.files.xlsx.sheet": "Planilha",
  "session.files.xlsx.empty": "Planilha vazia",
  "session.files.xlsx.download": "Baixar XLSX",
  "session.files.xlsx.tooLarge": "Esta planilha é grande demais para a prévia. Baixe o arquivo.",
  "session.files.xlsx.rows": "{{count}} linhas",
  "session.files.xlsx.columns": "{{count}} colunas",
  "session.files.pdf.page": "Página {{page}} de {{total}}",
  "session.files.pdf.prev": "Página anterior",
  "session.files.pdf.next": "Próxima página",
  "session.files.pdf.download": "Baixar PDF",
  "session.files.pdf.tooLarge": "Este PDF é grande demais para a prévia. Baixe o arquivo.",
  "session.files.pdf.loadFailed": "Não foi possível renderizar este PDF.",
  ...
  "settings.appearance.row.tabs.title": "Navegação",
  "settings.appearance.row.tabs.description": "Navegação lateral ou a faixa horizontal de abas (legado)",
  "settings.appearance.row.tabs.horizontal": "Abas horizontais (legado)",
  "settings.appearance.row.tabs.vertical": "Barra lateral",
  "settings.notifications.description": "Escolha quando receber notificações e sons",
  "settings.shortcuts.description": "Personalize atalhos para ações comuns",
  "settings.servers.description": "Gerencie conexões com servidores",
  "settings.projects.title": "Projetos",
  "settings.projects.description": "Gerencie as configurações dos projetos neste servidor",
  "settings.projects.empty": "Nenhum projeto encontrado",
  "settings.projects.server.all": "Todos os servidores",
  "settings.mcps.description": "Gerencie servidores e ferramentas MCP (Model Context Protocol)",
  "settings.extensions.description": "Gerencie as extensões disponíveis neste servidor",
  ...
  "settings.extensions.manageConfig": "Gerenciar no opencode.json",
  "settings.extensions.addSkills": "Como adicionar skills",
  "dialog.server.authenticate.title": "Autenticar",
  "project.settings.general.description": "Gerencie nome e aparência do projeto",
  "project.settings.scripts": "Scripts",
  "project.settings.scripts.description": "Configure scripts para este projeto",
  "project.settings.extensions.description": "Veja as extensões disponíveis para este projeto",
  "project.settings.extensions.tab.lsps": "LSPs",
  "project.settings.extensions.added": "Adicionadas a este projeto",
  "project.settings.extensions.shared": "Compartilhadas com todos os projetos",
  "project.settings.extensions.lsp.detected": "Servidores de linguagem detectados",
  "project.settings.extensions.lsp.description": "Detectados automaticamente pelos tipos de arquivo",
  ...
  "settings.general.row.terminalPlacement.description": "Escolha onde o terminal abre nas sessões",
  "settings.general.row.terminalPlacement.side": "Lateral",
  "settings.general.row.terminalPlacement.bottom": "Embaixo",
  ...
  "settings.general.row.followUpBehavior.title": "Comportamento de continuação",
  "settings.general.row.followUpBehavior.description": "Escolha entre enfileirar continuações ou direcionar o turno atual. Use {{keybind}} para alternar.",
  "settings.general.row.followUpBehavior.queue": "Enfileirar",
  "settings.general.row.followUpBehavior.steer": "Direcionar",
  "settings.general.row.reasoningMode.title": "Raciocínio do modelo",
  "settings.general.row.reasoningMode.description": "Escolha como o raciocínio do modelo aparece na linha do tempo",
  ...
  "session.new.workspace.local.tooltip": "Usar o checkout atual",
  "session.new.workspace.new.tooltip": "Criar checkout isolado",
  "session.new.workspace.fromBranch": "a partir de {{branch}}",
  "session.new.workspace.createFrom": "Criar a partir da branch",
  "session.new.workspace.branch.search.placeholder": "Buscar branches",
  "session.new.workspace.trigger.tooltip": "Escolha onde rodar a sessão",
  "session.new.workspace.search.placeholder": "Buscar espaços de trabalho",
  ...
  "settings.workspaces.deleteAll.confirm": "Excluir todos os {{count}} espaços de trabalho?",
  "settings.workspaces.delete.warning": "O diretório e a branch do espaço de trabalho serão removidos permanentemente, incluindo as alterações não mescladas mostradas abaixo.",
  "settings.workspaces.deleteAll.warning": "Os {{count}} espaços de trabalho selecionados em {{project}} só serão removidos se cada um estiver limpo, inativo e sem sessões vinculadas.",
  "settings.workspaces.delete.blocked.active": "O espaço de trabalho ativo não pode ser excluído.",
  "settings.workspaces.delete.blocked.linked": "As sessões vinculadas permanecem, mas o diretório de trabalho delas será removido permanentemente.",
  ...
  "settings.workspaces.default.lastUsed": "Último usado por projeto",
  "settings.workspaces.default.local": "Diretório local",
  "settings.workspaces.default.new": "Novo espaço de trabalho",
  "workspace.move.title": "Mover para espaço de trabalho",
  "workspace.move.menu.title": "Mover sessão para",
  "workspace.move.failed": "Falha ao mover a sessão",
  ...
  "workspace.onboarding.description": "Cada um tem o próprio checkout, então nada interfere no seu repositório local",
  ...
  "session.summary.basedOn": "Baseada em {{branch}}",
}
