...
export const dict = {
  ...
  "dialog.directory.home": "Home",

  "navSidebar.title": "Workspaces",
  "navSidebar.newSession": "New session",
  "navSidebar.search.placeholder": "Filter projects and sessions",
  "navSidebar.settings": "Settings",
  "navSidebar.empty.projects": "Add a project",
  "navSidebar.empty.sessions": "No sessions yet",
  "navSidebar.server.offline": "offline",
  "navSidebar.project.reveal": "Reveal in file manager",
  "navSidebar.session.unread": "Unread activity",

  "command.extensions.toggle": "Toggle skills & MCP panel",
  "session.sidebar.skills": "Skills",
  "session.sidebar.mcps": "MCP servers",
  "session.sidebar.skills.empty": "Skills available in this workspace show up here",
  "session.sidebar.mcps.empty": "No MCP servers",
  "session.sidebar.usage.active": "In use",
  "session.sidebar.usage.used": "Used in this session",
  "session.sidebar.agent.label": "Agent",
  "session.sidebar.agent.switch": "Switch agent",
  "session.sidebar.browser": "Browser",
  "session.sidebar.browser.empty": "No page yet — open the Browser tab",
  "session.sidebar.browser.open": "Open the Browser tab",
  "session.sidebar.skills.search": "Filter skills",
  "session.sidebar.skills.noMatch": "No skill matches",
  "session.sidebar.agents": "Subagents",
  "session.sidebar.agents.empty": "Subagents this session spawns show up here",
  "session.sidebar.tools": "Tools",
  "session.sidebar.tools.empty": "Detected MCP servers, API keys and CLIs show up here",
  "session.sidebar.tools.error": "Could not load tools — detection failed",
  "session.sidebar.tools.channel.mcp": "MCP server",
  "session.sidebar.tools.channel.api": "API key",
  "session.sidebar.tools.channel.cli": "CLI",
  "session.sidebar.tools.chip.mcp": "MCP",
  "session.sidebar.tools.chip.api": "API key",
  "session.sidebar.tools.chip.cli": "CLI",
  "session.sidebar.tools.notFound": "not found",
  "session.sidebar.tools.notConnected": "not connected",
  "session.sidebar.tools.connect": "Connect",
  "session.sidebar.tools.disconnect": "Disconnect",
  "session.sidebar.tools.tools": "{{count}} tools",
  "session.sidebar.tools.pinned": "Pinned for this agent",
  "session.sidebar.tools.denied": "Not allowed for this agent",
  "session.sidebar.tools.refresh": "Refresh detection",
  "session.sidebar.tools.envKeys": "{{count}} environment keys",
  "session.sidebar.routines": "Routines",
  "session.sidebar.routines.empty": "Scheduled prompts for this workspace show up here",
  "session.sidebar.routines.new": "New routine",
  "session.sidebar.routines.next": "next {{time}}",
  "session.sidebar.routines.paused": "paused",
  "session.sidebar.routines.run": "Run now",
  "session.sidebar.routines.toggle": "Enabled",
  "routine.dialog.create.title": "New routine",
  "routine.dialog.edit.title": "Edit routine",
  "routine.field.name": "Name",
  "routine.field.name.placeholder": "Every Monday: summarise new leads",
  "routine.field.agent": "Agent",
  "routine.field.schedule": "Schedule",
  "routine.field.time": "Time",
  "routine.field.weekday": "Weekday",
  "routine.field.timezone": "Time zone",
  "routine.field.cron": "Cron expression",
  "routine.field.cron.hint": "minute hour day month weekday",
  "routine.field.cron.invalid": "Enter a valid five-field cron expression",
  "routine.field.timezone.invalid": "Unknown time zone",
  "routine.field.minute.invalid": "Enter a minute from 0 to 59",
  "routine.field.task": "Task",
  "routine.field.task.prompt": "Prompt",
  "routine.field.task.command": "Project command",
  "routine.field.prompt.placeholder": "What should the agent do?",
  "routine.field.command.none": "No project commands",
  "routine.field.model": "Model",
  "routine.field.model.default": "Agent default",
  "routine.field.enabled": "Enabled",
  "routine.preset.hourly": "Every hour",
  "routine.preset.daily": "Every day",
  "routine.preset.weekly": "Every week",
  "routine.preset.custom": "Custom cron",
  "routine.history.title": "Last runs",
  "routine.history.empty": "No runs yet",
  "routine.history.open": "Open session",
  "routine.status.running": "Running",
  "routine.status.success": "Succeeded",
  "routine.status.error": "Failed",
  "routine.status.missed": "Missed",
  "routine.status.cancelled": "Cancelled",
  "routine.error.save": "Could not save the routine",
  "routine.error.run": "Could not start the routine",
  ...
  "session.tab.browser.empty.title": "No browser yet",
  "session.tab.browser.empty.description": "A browser for this agent will live here.",
  "session.browser.open": "Open browser",
  "session.browser.opening": "Opening browser…",
  "session.browser.tab.new": "New tab",
  "session.browser.tab.close": "Close tab",
  "session.browser.back": "Back",
  "session.browser.reload": "Reload",
  "session.browser.url.placeholder": "Enter a URL",
  "session.browser.control.idle": "Idle",
  "session.browser.control.agent": "Agent",
  "session.browser.control.human": "You",
  "session.browser.control.handoff-login": "Waiting for you",
  "session.browser.take": "Take over",
  "session.browser.release": "Hand back",
  "session.browser.handoff.banner": "The agent needs you: {{reason}}",
  "session.browser.handoff.done": "Done",
  "session.browser.stream.connecting": "Connecting to the page…",
  "session.browser.stream.closed": "Stream disconnected, reconnecting…",
  "session.browser.error": "Browser error: {{message}}",
  "session.workspace.tabs": "Session views",
  ...
  "session.review.filesChanged.one": "{{count}} File Changed",
  "session.review.filesChanged.other": "{{count}} Files Changed",
  ...
  "session.files.csv.empty": "Empty CSV file",
  "session.files.csv.download": "Download CSV",
  "session.files.csv.tooLarge": "This CSV is too large to preview. Download it instead.",
  "session.files.csv.rows": "{{count}} rows",
  "session.files.csv.columns": "{{count}} columns",
  "session.files.xlsx.sheet": "Sheet",
  "session.files.xlsx.empty": "Empty spreadsheet",
  "session.files.xlsx.download": "Download XLSX",
  "session.files.xlsx.tooLarge": "This spreadsheet is too large to preview. Download it instead.",
  "session.files.xlsx.rows": "{{count}} rows",
  "session.files.xlsx.columns": "{{count}} columns",
  "session.files.pdf.page": "Page {{page}} of {{total}}",
  "session.files.pdf.prev": "Previous page",
  "session.files.pdf.next": "Next page",
  "session.files.pdf.download": "Download PDF",
  "session.files.pdf.tooLarge": "This PDF is too large to preview. Download it instead.",
  "session.files.pdf.loadFailed": "This PDF could not be rendered.",
  ...
  "settings.appearance.row.tabs.title": "Navigation",
  "settings.appearance.row.tabs.description": "Sidebar navigation or the legacy horizontal tab strip",
  "settings.appearance.row.tabs.horizontal": "Horizontal tabs (legacy)",
  "settings.appearance.row.tabs.vertical": "Sidebar",
  ...
  "settings.updates.action.restarting": "Restarting...",
  "settings.updates.toast.installing.title": "Updating to {{version}}...",
  "settings.updates.toast.installing.description": "Running turns carry on after the restart.",
  "settings.updates.toast.restarting.title": "Restarting on {{version}}...",
  "settings.updates.toast.restarting.description": "The page reloads by itself once the server is back.",
  "settings.updates.toast.timeout.title": "Update to {{version}} did not finish",
  "settings.updates.toast.timeout.description": "The server did not come back in time. Restart force web by hand.",
  "settings.updates.toast.manual.title": "{{version}} is available",
  "settings.updates.toast.manual.description": "This installation cannot update itself. Run: {{command}}",
  "settings.updates.toast.manual.noCommand": "This installation cannot update itself. Reinstall force-agent to get it.",
  "navSidebar.update.check": "Check for updates",
  "navSidebar.update.install": "Update to {{version}}",
