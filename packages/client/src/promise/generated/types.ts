...
export type SelfUpdateManager = "npm" | "pnpm" | "bun" | "yarn" | "unknown"

export type SelfUpdateReason = "local" | "no-manager" | "unsupported-platform" | "disabled"

export type SelfUpdatePhaseIdle = { type: "idle" }

export type SelfUpdatePhaseChecking = { type: "checking" }

export type SelfUpdatePhaseInstalling = { type: "installing"; version: string }

export type SelfUpdatePhaseRestarting = { type: "restarting"; version: string; pid: number }

export type SelfUpdatePhaseError = { type: "error"; message: string; hint?: string | undefined }
...
export type CapabilityApiMethod = "key" | "env" | "oauth"

export type CapabilityCliChannel = { binary: string; path?: string; found: boolean }

export type RoutineSchedule = string

export type RoutineTimezone = string

export type RoutineRunStatus = "running" | "success" | "error" | "missed" | "cancelled"
...
export type BrowserProvider = "launched" | "desktop"

export type BrowserControl = "idle" | "agent" | "human" | "handoff-login"
...
export type BrowserTicketConnectToken = { ticket: string; expires_in: number }

export type BrowserSnapshotMode = "full" | "diff" | "interactive"

export type BrowserNetworkCaptured = "agent" | "human"

export type BrowserNetworkBody = { id: string; body: string; base64: boolean; truncated: boolean }

export type SelfUpdatePhase =
  | SelfUpdatePhaseIdle
  | SelfUpdatePhaseChecking
  | SelfUpdatePhaseInstalling
  | SelfUpdatePhaseRestarting
  | SelfUpdatePhaseError
...
export type RoutineUpdated = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "routine.updated"
  location?: LocationRef
  data: { routineID: string }
}

export type RoutineRunStarted = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "routine.run.started"
  location?: LocationRef
  data: { routineID: string; runID: string; sessionID?: string }
}
...
export type CapabilityMcpChannel = {
  server: string
  status: McpStatusConnected | McpStatusPending | McpStatusDisabled | McpStatusFailed | McpStatusNeedsAuth
  tools: number
}
...
export type CapabilityApiChannel = {
  integrationID?: string
...
export type RoutineRunFinished = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "routine.run.finished"
  location?: LocationRef
  data: { routineID: string; runID: string; status: RoutineRunStatus }
}
...
export type BrowserTab = { id: BrowserTabID; url: string; title: string; active: boolean; thumbnailVersion: number }

export type BrowserHandoff = { tab: BrowserTabID; reason: string; until?: string; since: number }

export type BrowserTabUrl = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "browser.tab.url"
  location?: LocationRef
  data: { tab: BrowserTabID; url: string; title: string }
}
...
export type BrowserThumbnail = {
  ...
  location?: LocationRef
  data: { tab: BrowserTabID; version: number }
}
...
export type BrowserActResult = { tab: BrowserTabID; url: string; title: string; version: number; diff: string }

export type BrowserScreenshotResult = { tab: BrowserTabID; url: string; mime: string; base64: string }
...
export type BrowserEvalResult = { tab: BrowserTabID; url: string; json: string; truncated: boolean }
...
export type BrowserNetworkEntry = {
  ...
  timestamp: number
  fromCache: boolean
  captured: BrowserNetworkCaptured
  error?: string
}
...
export type SelfUpdateStatus = {
  ...
  canApply: boolean
  reason?: SelfUpdateReason | undefined
...
export type CapabilityChannels = {
  mcp?: Array<CapabilityMcpChannel>
  api?: CapabilityApiChannel
...
export type BrowserTabChanged = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "browser.tab.changed"
  location?: LocationRef
  data: { tab: BrowserTab; op: "opened" | "closed" | "activated" }
}
...
export type BrowserHandoffRequested = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "browser.handoff.requested"
  location?: LocationRef
  data: { handoff: BrowserHandoff }
}
...
export type InstallationUpdateState = {
  id: string
  created: number
  metadata?: { [x: string]: any }
  type: "installation.update-state"
  location?: LocationRef
  data: { status: SelfUpdateStatus }
}
...
export type BrowserUnavailableError = { readonly _tag: "BrowserUnavailableError"; readonly message: string }
export const isBrowserUnavailableError = (value: unknown): value is BrowserUnavailableError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "BrowserUnavailableError"

export type BrowserTabNotFoundError = {
  readonly _tag: "BrowserTabNotFoundError"
  readonly tabID: string
  readonly message: string
}
export const isBrowserTabNotFoundError = (value: unknown): value is BrowserTabNotFoundError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "BrowserTabNotFoundError"

export type BrowserControlError = {
  readonly _tag: "BrowserControlError"
  readonly state: string
  readonly hint: string
  readonly message: string
}
export const isBrowserControlError = (value: unknown): value is BrowserControlError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "BrowserControlError"

export type BrowserActionError = { readonly _tag: "BrowserActionError"; readonly message: string }
export const isBrowserActionError = (value: unknown): value is BrowserActionError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "BrowserActionError"

export type HealthGetOutput = ServiceHealth

export type ServerGetOutput = { urls: Array<string> }

export type UpdateGetInput = { readonly refresh?: { readonly refresh?: boolean | undefined }["refresh"] }

export type UpdateGetOutput = SelfUpdateStatus

export type UpdateApplyInput = { readonly version?: { readonly version?: string | undefined }["version"] }

export type UpdateApplyOutput = SelfUpdateStatus
...
export type McpToolsOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: Array<McpToolSummary>
}
...
export type CapabilityRefreshInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
}

export type CapabilityRefreshOutput = void

export type RoutineListInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
}

export type RoutineListOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
...
export type RoutineCreateOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: RoutineInfo
}
...
export type RoutineUpdateOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: RoutineInfo
}

export type RoutineRemoveInput = {
  readonly id: { readonly id: string }["id"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type RoutineRemoveOutput = void

export type RoutineRunInput = {
  readonly id: { readonly id: string }["id"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type RoutineRunOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: RoutineRun
}

export type RoutineRunsInput = {
  readonly id: { readonly id: string }["id"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
    readonly limit?: number | undefined
...
export type BrowserStateOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserState
}

export type BrowserTabOpenInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly url?: { readonly url?: string }["url"]
...
export type BrowserTabOpenOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserTab
}

export type BrowserTabCloseInput = {
...
export type BrowserTabCloseOutput = void

export type BrowserTabActivateInput = {
  readonly tabID: { readonly tabID: string }["tabID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type BrowserTabActivateOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserTab
}

export type BrowserTabBackInput = {
  readonly tabID: { readonly tabID: string }["tabID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type BrowserTabBackOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserTab
}

export type BrowserTabReloadInput = {
  readonly tabID: { readonly tabID: string }["tabID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type BrowserTabReloadOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserTab
}

export type BrowserTabTicketInput = {
  readonly tabID: { readonly tabID: string }["tabID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type BrowserTabTicketOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserTicketConnectToken
}

export type BrowserTabStreamInput = { readonly tabID: { readonly tabID: string }["tabID"] }

export type BrowserTabStreamOutput = boolean

export type BrowserThumbnailInput = {
  readonly tabID: { readonly tabID: string }["tabID"]
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
...
export type BrowserThumbnailOutput = globalThis.Uint8Array

export type BrowserNavigateInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly url: { readonly url: string; readonly tab?: string; readonly wait?: "load" | "networkidle" }["url"]
  readonly tab?: { readonly url: string; readonly tab?: string; readonly wait?: "load" | "networkidle" }["tab"]
  readonly wait?: { readonly url: string; readonly tab?: string; readonly wait?: "load" | "networkidle" }["wait"]
}
...
export type BrowserControlInput = {
  ...
  readonly owner: { readonly owner: "human" | "agent" | "release" }["owner"]
}
...
export type BrowserSnapshotInput = {
  ...
  readonly tab?: {
    readonly tab?: string
    readonly mode?: "full" | "diff" | "interactive"
...
export type BrowserReadInput = {
  ...
  readonly tab?: { readonly tab?: string; readonly selector?: string; readonly page?: number }["tab"]
  readonly selector?: { readonly tab?: string; readonly selector?: string; readonly page?: number }["selector"]
  readonly page?: { readonly tab?: string; readonly selector?: string; readonly page?: number }["page"]
}

export type BrowserReadOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserReadResult
}
...
export type BrowserActInput = {
  ...
  readonly tab?: {
    readonly tab?: string
    readonly action: "click" | "type" | "press" | "select" | "scroll" | "hover" | "upload"
    readonly ref?: string
    readonly text?: string
    readonly key?: string
    readonly value?: string
...
export type BrowserActOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserActResult
}
...
export type BrowserScreenshotInput = {
  ...
  readonly tab?: { readonly tab?: string; readonly ref?: string; readonly fullPage?: boolean }["tab"]
  readonly ref?: { readonly tab?: string; readonly ref?: string; readonly fullPage?: boolean }["ref"]
  readonly fullPage?: { readonly tab?: string; readonly ref?: string; readonly fullPage?: boolean }["fullPage"]
}
...
export type BrowserNetworkInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly tab?: {
...
export type BrowserNetworkOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserNetworkResult
}
...
export type BrowserFetchOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserFetchResult
}

export type BrowserEvalInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
  readonly tab?: { readonly tab?: string; readonly expression: string; readonly timeoutMs?: number }["tab"]
  readonly expression: { readonly tab?: string; readonly expression: string; readonly timeoutMs?: number }["expression"]
  readonly timeoutMs?: { readonly tab?: string; readonly expression: string; readonly timeoutMs?: number }["timeoutMs"]
}

export type BrowserEvalOutput = {
  location: { directory: string; workspaceID?: string; project: { id: string; directory: string; canonical: string } }
  data: BrowserEvalResult
}

export type BrowserProviderOutput = boolean
