import type {
  ...
  BrowserStateOutput,
  BrowserTabOpenInput,
  BrowserTabOpenOutput,
  BrowserTabCloseInput,
  BrowserTabCloseOutput,
  BrowserTabActivateInput,
  BrowserTabActivateOutput,
  BrowserTabBackInput,
  BrowserTabBackOutput,
  BrowserTabReloadInput,
  BrowserTabReloadOutput,
  BrowserTabTicketInput,
  BrowserTabTicketOutput,
  BrowserTabStreamInput,
  BrowserTabStreamOutput,
  BrowserThumbnailInput,
  BrowserThumbnailOutput,
  ...
  BrowserNetworkInput,
  BrowserNetworkOutput,
  BrowserFetchInput,
  BrowserFetchOutput,
  BrowserEvalInput,
  BrowserEvalOutput,
  BrowserProviderOutput,
} from "./types.js"
...
export function make(options: ClientOptions) {
  ...
  const responseError = async (response: Response, descriptor: RequestDescriptor): Promise<never> => {
    if (descriptor.declaredStatuses.includes(response.status)) {
      // A declared status whose body is not JSON (a 401 with an empty body, say)
      // must not lose the status: without it the caller sees only
      // "UnsupportedContentType" and cannot tell a rejected credential from a
      // transient hiccup, so it retries forever.
      let payload: unknown
      try {
        payload = await json(response)
      } catch (cause) {
        throw new ClientError("UnexpectedStatus", { cause: { status: response.status, cause } })
      }
      throw payload
    }
    try {
  ...
  return {
    ...
    update: {
      get: (input?: UpdateGetInput, requestOptions?: RequestOptions) =>
        request<UpdateGetOutput>(
          {
            method: "GET",
            path: `/api/update`,
      ...
      apply: (input?: UpdateApplyInput, requestOptions?: RequestOptions) =>
        request<UpdateApplyOutput>(
          {
            method: "POST",
    ...
    mcp: {
      ...
      tools: (input: McpToolsInput, requestOptions?: RequestOptions) =>
        request<McpToolsOutput>(
          {
            method: "GET",
            path: `/api/mcp/${encodeURIComponent(input.server)}/tools`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
    ...
    capability: {
      ...
      refresh: (input?: CapabilityRefreshInput, requestOptions?: RequestOptions) =>
        request<CapabilityRefreshOutput>(
          {
            method: "POST",
            path: `/api/capability/refresh`,
            query: { location: input?.["location"] },
            successStatus: 204,
            declaredStatuses: [401, 400],
            empty: true,
    ...
    routine: {
      list: (input?: RoutineListInput, requestOptions?: RequestOptions) =>
        request<RoutineListOutput>(
          {
            method: "GET",
            path: `/api/routine`,
            query: { location: input?.["location"] },
      ...
      create: (input: RoutineCreateInput, requestOptions?: RequestOptions) =>
        request<RoutineCreateOutput>(
          {
            method: "POST",
            path: `/api/routine`,
            query: { location: input["location"] },
      ...
      update: (input: RoutineUpdateInput, requestOptions?: RequestOptions) =>
        request<RoutineUpdateOutput>(
          {
            method: "PUT",
            path: `/api/routine/${encodeURIComponent(input.id)}`,
            query: { location: input["location"] },
            body: {
              name: input["name"],
              agent: input["agent"],
      ...
      remove: (input: RoutineRemoveInput, requestOptions?: RequestOptions) =>
        request<RoutineRemoveOutput>(
          {
            method: "DELETE",
            path: `/api/routine/${encodeURIComponent(input.id)}`,
            query: { location: input["location"] },
      ...
      run: (input: RoutineRunInput, requestOptions?: RequestOptions) =>
        request<RoutineRunOutput>(
          {
            method: "POST",
            path: `/api/routine/${encodeURIComponent(input.id)}/run`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
      ...
      runs: (input: RoutineRunsInput, requestOptions?: RequestOptions) =>
        request<RoutineRunsOutput>(
          {
            method: "GET",
            path: `/api/routine/${encodeURIComponent(input.id)}/runs`,
            query: { location: input["location"], limit: input["limit"] },
            successStatus: 200,
            declaredStatuses: [401, 400],
            empty: false,
          },
    ...
    browser: {
      state: (input?: BrowserStateInput, requestOptions?: RequestOptions) =>
        request<BrowserStateOutput>(
          {
            method: "GET",
            path: `/api/browser`,
            query: { location: input?.["location"] },
      ...
      tab: {
        open: (input?: BrowserTabOpenInput, requestOptions?: RequestOptions) =>
          request<BrowserTabOpenOutput>(
            {
              method: "POST",
              ...
              body: { url: input?.["url"] },
              successStatus: 200,
              declaredStatuses: [503, 404, 409, 400, 401],
              empty: false,
            },
            requestOptions,
          ),
        close: (input: BrowserTabCloseInput, requestOptions?: RequestOptions) =>
          request<BrowserTabCloseOutput>(
            {
              method: "DELETE",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}`,
              query: { location: input["location"] },
              successStatus: 204,
              declaredStatuses: [503, 404, 409, 400, 401],
              empty: true,
        ...
        activate: (input: BrowserTabActivateInput, requestOptions?: RequestOptions) =>
          request<BrowserTabActivateOutput>(
            {
              method: "POST",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/activate`,
              query: { location: input["location"] },
              successStatus: 200,
              declaredStatuses: [503, 404, 409, 400, 401],
              empty: false,
        ...
        back: (input: BrowserTabBackInput, requestOptions?: RequestOptions) =>
          request<BrowserTabBackOutput>(
            {
              method: "POST",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/back`,
              query: { location: input["location"] },
              successStatus: 200,
              declaredStatuses: [503, 404, 409, 400, 401],
              empty: false,
        ...
        reload: (input: BrowserTabReloadInput, requestOptions?: RequestOptions) =>
          request<BrowserTabReloadOutput>(
            {
              method: "POST",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/reload`,
              query: { location: input["location"] },
              successStatus: 200,
              declaredStatuses: [503, 404, 409, 400, 401],
              empty: false,
        ...
        ticket: (input: BrowserTabTicketInput, requestOptions?: RequestOptions) =>
          request<BrowserTabTicketOutput>(
            {
              method: "POST",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/ticket`,
              query: { location: input["location"] },
              headers: { "x-opencode-ticket": input["x-opencode-ticket"] },
              successStatus: 200,
              declaredStatuses: [403, 503, 404, 409, 400, 401],
              empty: false,
            },
            requestOptions,
          ),
        stream: (input: BrowserTabStreamInput, requestOptions?: RequestOptions) =>
          request<BrowserTabStreamOutput>(
            {
              method: "GET",
              path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/stream`,
              successStatus: 200,
              declaredStatuses: [403, 404, 401, 400],
              empty: false,
            },
      ...
      thumbnail: (input: BrowserThumbnailInput, requestOptions?: RequestOptions) =>
        request<BrowserThumbnailOutput>(
          {
            method: "GET",
            path: `/api/browser/tabs/${encodeURIComponent(input.tabID)}/thumbnail`,
            query: { location: input["location"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
      ...
      navigate: (input: BrowserNavigateInput, requestOptions?: RequestOptions) =>
        request<BrowserNavigateOutput>(
          {
            method: "POST",
            path: `/api/browser/navigate`,
            query: { location: input["location"] },
            body: { url: input["url"], tab: input["tab"], wait: input["wait"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
          },
      ...
      snapshot: (input?: BrowserSnapshotInput, requestOptions?: RequestOptions) =>
        request<BrowserSnapshotOutput>(
          {
            method: "POST",
            path: `/api/browser/snapshot`,
            query: { location: input?.["location"] },
            body: { tab: input?.["tab"], mode: input?.["mode"], maxNodes: input?.["maxNodes"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
          },
      ...
      read: (input?: BrowserReadInput, requestOptions?: RequestOptions) =>
        request<BrowserReadOutput>(
          {
            method: "POST",
            path: `/api/browser/read`,
            query: { location: input?.["location"] },
            body: { tab: input?.["tab"], selector: input?.["selector"], page: input?.["page"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
          },
      ...
      act: (input: BrowserActInput, requestOptions?: RequestOptions) =>
        request<BrowserActOutput>(
          {
            method: "POST",
      ...
      screenshot: (input?: BrowserScreenshotInput, requestOptions?: RequestOptions) =>
        request<BrowserScreenshotOutput>(
          {
            method: "POST",
            path: `/api/browser/screenshot`,
            query: { location: input?.["location"] },
            body: { tab: input?.["tab"], ref: input?.["ref"], fullPage: input?.["fullPage"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
          },
      ...
      network: (input?: BrowserNetworkInput, requestOptions?: RequestOptions) =>
        request<BrowserNetworkOutput>(
          {
            method: "POST",
      ...
      fetch: (input: BrowserFetchInput, requestOptions?: RequestOptions) =>
        request<BrowserFetchOutput>(
          {
            method: "POST",
      ...
      eval: (input: BrowserEvalInput, requestOptions?: RequestOptions) =>
        request<BrowserEvalOutput>(
          {
            method: "POST",
            path: `/api/browser/eval`,
            query: { location: input["location"] },
            body: { tab: input["tab"], expression: input["expression"], timeoutMs: input["timeoutMs"] },
            successStatus: 200,
            declaredStatuses: [503, 404, 409, 400, 401],
            empty: false,
          },
      ...
      provider: (requestOptions?: RequestOptions) =>
        request<BrowserProviderOutput>(
          {
            method: "GET",
            path: `/api/browser/provider`,
            successStatus: 200,
