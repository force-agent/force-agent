...
import type { SelfUpdate } from "@opencode-ai/schema/self-update"
...
export type UpdateGetInput = { readonly refresh?: boolean | undefined }
export type UpdateGetOutput = SelfUpdate.Status
export type UpdateGetOperation<E = never> = (input?: UpdateGetInput) => Effect.Effect<UpdateGetOutput, E>

export type UpdateApplyInput = { readonly version?: string | undefined }
export type UpdateApplyOutput = SelfUpdate.Status
export type UpdateApplyOperation<E = never> = (input?: UpdateApplyInput) => Effect.Effect<UpdateApplyOutput, E>

export interface UpdateApi<E = never> {
  readonly get: UpdateGetOperation<E>
  readonly apply: UpdateApplyOperation<E>
}
...
export type McpToolsOutput = { readonly location: Location.Info; readonly data: ReadonlyArray<Mcp.ToolSummary> }
...
export type CapabilityListOutput = { readonly location: Location.Info; readonly data: ReadonlyArray<Capability.Info> }
export type CapabilityListOperation<E = never> = (input?: CapabilityListInput) => Effect.Effect<CapabilityListOutput, E>

export type CapabilityRefreshInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type CapabilityRefreshOutput = void
export type CapabilityRefreshOperation<E = never> = (
  input?: CapabilityRefreshInput,
) => Effect.Effect<CapabilityRefreshOutput, E>

export interface CapabilityApi<E = never> {
  readonly list: CapabilityListOperation<E>
  readonly refresh: CapabilityRefreshOperation<E>
}

export type RoutineListInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type RoutineListOutput = { readonly location: Location.Info; readonly data: ReadonlyArray<Routine.Info> }
export type RoutineListOperation<E = never> = (input?: RoutineListInput) => Effect.Effect<RoutineListOutput, E>
...
export type RoutineCreateInput = {
  ...
  readonly timezone: Routine.Timezone
  readonly prompt?: string | undefined
  readonly commandID?: string | undefined
  readonly model?: Model.Ref | undefined
  readonly enabled?: boolean | undefined
}
export type RoutineCreateOutput = { readonly location: Location.Info; readonly data: Routine.Info }
export type RoutineCreateOperation<E = never> = (input: RoutineCreateInput) => Effect.Effect<RoutineCreateOutput, E>

export type RoutineUpdateInput = {
  readonly id: Routine.ID
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  readonly name?: string | undefined
  readonly agent?: Agent.ID | undefined
  readonly schedule?: Routine.Schedule | undefined
  readonly timezone?: Routine.Timezone | undefined
  readonly prompt?: string | null | undefined
  readonly commandID?: string | null | undefined
  readonly model?: Model.Ref | null | undefined
  readonly enabled?: boolean | undefined
}
export type RoutineUpdateOutput = { readonly location: Location.Info; readonly data: Routine.Info }
export type RoutineUpdateOperation<E = never> = (input: RoutineUpdateInput) => Effect.Effect<RoutineUpdateOutput, E>
...
export type RoutineRemoveOperation<E = never> = (input: RoutineRemoveInput) => Effect.Effect<RoutineRemoveOutput, E>

export type RoutineRunInput = {
  readonly id: Routine.ID
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type RoutineRunOutput = { readonly location: Location.Info; readonly data: Routine.Run }
export type RoutineRunOperation<E = never> = (input: RoutineRunInput) => Effect.Effect<RoutineRunOutput, E>
...
export type RoutineRunsOutput = { readonly location: Location.Info; readonly data: ReadonlyArray<Routine.Run> }
export type RoutineRunsOperation<E = never> = (input: RoutineRunsInput) => Effect.Effect<RoutineRunsOutput, E>

export interface RoutineApi<E = never> {
  readonly list: RoutineListOperation<E>
  readonly create: RoutineCreateOperation<E>
  readonly update: RoutineUpdateOperation<E>
  readonly remove: RoutineRemoveOperation<E>
  readonly run: RoutineRunOperation<E>
  readonly runs: RoutineRunsOperation<E>
}
...
export type BrowserStateOutput = { readonly location: Location.Info; readonly data: Browser.State }
export type BrowserStateOperation<E = never> = (input?: BrowserStateInput) => Effect.Effect<BrowserStateOutput, E>

export type BrowserTabOpenInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  readonly url?: string | undefined
}
export type BrowserTabOpenOutput = { readonly location: Location.Info; readonly data: Browser.Tab }
export type BrowserTabOpenOperation<E = never> = (input?: BrowserTabOpenInput) => Effect.Effect<BrowserTabOpenOutput, E>
...
export type BrowserTabCloseOperation<E = never> = (
  input: BrowserTabCloseInput,
) => Effect.Effect<BrowserTabCloseOutput, E>

export type BrowserTabActivateInput = {
  readonly tabID: Browser.TabID
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type BrowserTabActivateOutput = { readonly location: Location.Info; readonly data: Browser.Tab }
export type BrowserTabActivateOperation<E = never> = (
  input: BrowserTabActivateInput,
) => Effect.Effect<BrowserTabActivateOutput, E>

export type BrowserTabBackInput = {
  readonly tabID: Browser.TabID
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type BrowserTabBackOutput = { readonly location: Location.Info; readonly data: Browser.Tab }
export type BrowserTabBackOperation<E = never> = (input: BrowserTabBackInput) => Effect.Effect<BrowserTabBackOutput, E>

export type BrowserTabReloadInput = {
  readonly tabID: Browser.TabID
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
}
export type BrowserTabReloadOutput = { readonly location: Location.Info; readonly data: Browser.Tab }
export type BrowserTabReloadOperation<E = never> = (
  input: BrowserTabReloadInput,
) => Effect.Effect<BrowserTabReloadOutput, E>
...
export type BrowserTabTicketOperation<E = never> = (
  input: BrowserTabTicketInput,
) => Effect.Effect<BrowserTabTicketOutput, E>

export type BrowserTabStreamInput = { readonly tabID: Browser.TabID }
export type BrowserTabStreamOutput = boolean
export type BrowserTabStreamOperation<E = never> = (
  input: BrowserTabStreamInput,
) => Effect.Effect<BrowserTabStreamOutput, E>

export type BrowserNavigateInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  readonly url: string
  readonly tab?: Browser.TabID | undefined
  readonly wait?: Browser.Wait | undefined
}
export type BrowserNavigateOutput = { readonly location: Location.Info; readonly data: Browser.Snapshot }
export type BrowserNavigateOperation<E = never> = (
  input: BrowserNavigateInput,
) => Effect.Effect<BrowserNavigateOutput, E>

export type BrowserControlInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  readonly owner: Browser.ControlOwner
}
export type BrowserControlOutput = { readonly location: Location.Info; readonly data: Browser.State }
export type BrowserControlOperation<E = never> = (input: BrowserControlInput) => Effect.Effect<BrowserControlOutput, E>

export type BrowserSnapshotInput = {
  readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  readonly tab?: Browser.TabID | undefined
  readonly mode?: Browser.SnapshotMode | undefined
  readonly maxNodes?: number | undefined
}
export type BrowserSnapshotOutput = { readonly location: Location.Info; readonly data: Browser.Snapshot }
export type BrowserSnapshotOperation<E = never> = (
  input?: BrowserSnapshotInput,
) => Effect.Effect<BrowserSnapshotOutput, E>
...
export type BrowserReadOutput = { readonly location: Location.Info; readonly data: Browser.ReadResult }
export type BrowserReadOperation<E = never> = (input?: BrowserReadInput) => Effect.Effect<BrowserReadOutput, E>
...
export type BrowserActOutput = { readonly location: Location.Info; readonly data: Browser.ActResult }
export type BrowserActOperation<E = never> = (input: BrowserActInput) => Effect.Effect<BrowserActOutput, E>
...
export type BrowserScreenshotOutput = { readonly location: Location.Info; readonly data: Browser.ScreenshotResult }
export type BrowserScreenshotOperation<E = never> = (
  input?: BrowserScreenshotInput,
) => Effect.Effect<BrowserScreenshotOutput, E>
...
export type BrowserNetworkInput = {
  ...
  readonly xhr?: boolean | undefined
  readonly since?: number | undefined
  readonly limit?: number | undefined
  readonly body?: string | undefined
}
export type BrowserNetworkOutput = { readonly location: Location.Info; readonly data: Browser.NetworkResult }
export type BrowserNetworkOperation<E = never> = (input?: BrowserNetworkInput) => Effect.Effect<BrowserNetworkOutput, E>
...
export type BrowserFetchOutput = { readonly location: Location.Info; readonly data: Browser.FetchResult }
export type BrowserFetchOperation<E = never> = (input: BrowserFetchInput) => Effect.Effect<BrowserFetchOutput, E>
...
export type BrowserEvalOutput = { readonly location: Location.Info; readonly data: Browser.EvalResult }
export type BrowserEvalOperation<E = never> = (input: BrowserEvalInput) => Effect.Effect<BrowserEvalOutput, E>

export type BrowserProviderOutput = boolean
export type BrowserProviderOperation<E = never> = () => Effect.Effect<BrowserProviderOutput, E>

export interface BrowserApi<E = never> {
  readonly state: BrowserStateOperation<E>
  readonly tab: {
    readonly open: BrowserTabOpenOperation<E>
    readonly close: BrowserTabCloseOperation<E>
    readonly activate: BrowserTabActivateOperation<E>
    readonly back: BrowserTabBackOperation<E>
    readonly reload: BrowserTabReloadOperation<E>
    readonly ticket: BrowserTabTicketOperation<E>
    readonly stream: BrowserTabStreamOperation<E>
  }
  readonly navigate: BrowserNavigateOperation<E>
  readonly control: BrowserControlOperation<E>
  readonly snapshot: BrowserSnapshotOperation<E>
  readonly read: BrowserReadOperation<E>
  readonly act: BrowserActOperation<E>
  readonly screenshot: BrowserScreenshotOperation<E>
  readonly network: BrowserNetworkOperation<E>
  readonly fetch: BrowserFetchOperation<E>
  readonly eval: BrowserEvalOperation<E>
  readonly provider: BrowserProviderOperation<E>
}

export interface AppApi<E = never> {
  readonly health: HealthApi<E>
  readonly server: ServerApi<E>
  readonly update: UpdateApi<E>
