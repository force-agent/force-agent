...
const effectTypeReferences = [
  ...
  ...namespaceTypes("Browser", "@opencode-ai/schema/browser", Browser),
  ...
  ...namespaceTypes("Routine", "@opencode-ai/schema/routine", Routine),
  ...namespaceTypes("SelfUpdate", "@opencode-ai/schema/self-update", SelfUpdate),
