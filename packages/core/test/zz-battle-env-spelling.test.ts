...
const applyBudget = Effect.sync(() => {
  process.env["POWER_AGENT_CONCURRENCY"] = "2"
  delete process.env["OPENCODE_AGENT_CONCURRENCY"]
  process.env["POWER_AGENT_SPAWN_LIMIT"] = "50"
  delete process.env["OPENCODE_AGENT_SPAWN_LIMIT"]
})
...
describe("BATTLE: POWER_ env spelling", () => {
