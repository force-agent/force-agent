...
export const api: ElectronAPI = {
  ...
  browserView: {
    setBounds: (location, bounds) => invoke("BrowserSetBounds", { location, bounds }),
    setVisible: (location, visible) => invoke("BrowserSetVisible", { location, visible }),
    focus: (location) => invoke("BrowserFocus", { location }),
  },
}
